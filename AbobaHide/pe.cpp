...
ULONG PE::GetExportOffset(const unsigned char* FileData, ULONG FileSize, const char* ExportName)
{
    ...
    {
        Log("[ABOBAHIDE] Invalid IMAGE_DOS_SIGNATURE!\r\n");
        return PE_ERROR_VALUE;
    }
    ...
    {
        Log("[ABOBAHIDE] Invalid IMAGE_NT_SIGNATURE!\r\n");
        return PE_ERROR_VALUE;
    }
    ...
    {
        Log("[ABOBAHIDE] Invalid Export Directory!\r\n");
        return PE_ERROR_VALUE;
    }
    ...
    {
        Log("[ABOBAHIDE] Invalid Export Directory Contents!\r\n");
        return PE_ERROR_VALUE;
    }
    ...
    {
        Log("[ABOBAHIDE] Export %s not found in export table!\r\n", ExportName);
    }
