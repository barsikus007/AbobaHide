...
PVOID SSDT::GetFunctionAddress(const char* apiname)
{
    ...
    if(!SSDT)
    {
        Log("[ABOBAHIDE] SSDT not found...\r\n");
        return 0;
    }
    ULONG_PTR SSDTbase = (ULONG_PTR)SSDT->pServiceTable;
    if(!SSDTbase)
    {
        Log("[ABOBAHIDE] ServiceTable not found...\r\n");
        return 0;
    }
    ...
    {
        Log("[ABOBAHIDE] Invalid read offset...\r\n");
        return 0;
    }
#ifdef _WIN64
...
HOOK SSDT::Hook(const char* apiname, void* newfunc)
{
    ...
    {
        Log("[ABOBAHIDE] Invalid API offset...\r\n");
        return 0;
    }
    ...
    */
    ...
    if(!CaveAddress)
    {
        Log("[ABOBAHIDE] FindCaveAddress failed...\r\n");
        return 0;
    }
    Log("[ABOBAHIDE] CaveAddress: 0x%p\r\n", CaveAddress);
